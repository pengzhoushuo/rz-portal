	...
	<div class="row">
	    <div class="col-md-12">
	    	<div class="app-table-box" style="margin-top:20px;">
	    		<form id="addExpressForm" action="${ctx}/memberuser/resetPwd" method="post" class="form-horizontal" onsubmit="return check();";>
					<input type="hidden" name="id" value="${memberUser.id}"/>
					<div class="form-group">
						<label class="col-sm-2 control-label">用户名：</label>
						<div class="col-sm-8">${memberUser.userName}</div>
					</div>
					<div class="form-group">
