 ...
 */
@Controller
@RequestMapping({"/rndcode"})
public class RndCodeAction{
	...
	@ResponseBody
	public BaseResponse<String> validateRndCode(Model model, HttpServletRequest req){
	 ...
	 * @throws IOException
	 */
	@RequestMapping(value = "showRndCodeImg",method = RequestMethod.GET)
	public void showRndCodeImg(HttpServletRequest req, HttpServletResponse resp)
			throws IOException {
...
//		gd.drawRect(0, 0, width - 1, height - 1);
		...
		for (int i = 0; i < codeCount; i++) {
			...
			gd.drawString(code, i * xx + random.nextInt(5), codeY);
